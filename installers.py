...
Win32CommandLine:
    ...
    # Build Installer
    pyinstaller --runtime-hook rthook_pyqt4.py _installers/pyinstaller-client.spec -y
...
def fix_command_tuple(command_tuple, sudo=False, shell=False, win32=ut.WIN32):
    ...
    Example0:
        ...
        >>> command_tuple = ('pyinstaller', '_installers/pyinstaller-client.spec') #, '-y'
    ...
    Example1:
        >>> # DISABLE_DOCTEST
        >>> from utool.util_cplat import *  # NOQA
        >>> command_tuple = 'pyinstaller --runtime-hook rthook_pyqt4.py _installers/pyinstaller-client.spec -y'
        >>> result = fix_command_tuple(command_tuple)
        >>> print(result)
    """
    args = command_tuple
